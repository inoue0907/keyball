...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    RGB_TOG  , AML_TO   , KC_1     , KC_2     , KC_3     ,S(KC_MINS), S(KC_8)  ,            S(KC_9)  , KC_PGDN  , CPI_D100 , CPI_I100 , SCRL_DVI , SCRL_DVD , KBC_SAVE ,
    QK_BOOT  , _______  , KC_0     , KC_DOT   , _______  , _______  , _______  ,             KC_DEL  , _______  , CPI_D1K  , CPI_I1K  , EE_CLR   , KBC_RST  , QK_BOOT
  ),
  ...
  [4] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , KC_BTN1  , _______  , KC_BTN2  , KC_BTN3  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,            _______  , _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,            _______  , _______  , _______  , _______  , _______  , _______  , _______
  ),
};
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    // Deactivate AML when layer 3 (scroll) is active so scroll takes priority
    if (layer_state_cmp(state, 3)) {
        state &= ~((layer_state_t)1 << AUTO_MOUSE_DEFAULT_LAYER);
